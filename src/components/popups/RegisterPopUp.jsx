...
const RegisterPopUp = ({ handleClose }) => {
  ...
  //Registration validation using yup
                  ...
                  <Box m={2}>
                    <FormControl className="custom-input-box">
                      ...
                      <Select
                        ...
                        label="Avatar"
                      >
                        <MenuItem value="/images/Avatar00.png">Default</MenuItem>
                        <MenuItem value="/images/Avatar04.png">Female 1</MenuItem>
                        <MenuItem value="/images/Avatar05.png">Female 2</MenuItem>
                        <MenuItem value="/images/Avatar06.png">Female 3</MenuItem>
                        <MenuItem value="/images/Avatar01.png">Male 1</MenuItem>
                        <MenuItem value="/images/Avatar02.png">Male 2</MenuItem>
                        <MenuItem value="/images/Avatar03.png">Male 3</MenuItem>
                      </Select>
                    </FormControl>
                  </Box>
                  <Box m={2}>
